            ...
            <?php foreach ($templateData['lot'] as $key => $val) : ?>
                <li class="lots__item lot">
                    ...
                    <div class="lot__info">
                        ...
                        <h3 class="lot__title"><a class="text-link" href="/lot.php?id=<?=$key; ?>"><?=htmlspecialchars($val['lot-name']); ?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=htmlspecialchars($val['lot-rate']); ?><b class="rub">р</b></span>
                            </div>
